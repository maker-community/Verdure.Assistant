...
|-------------|------------------|------------|-----------|----------------|
| **[Console Application](/en/projects/console)** | Windows/Linux/macOS | ⭐⭐ | Core architecture, server deployment | 1️⃣ First choice |
| **[WinUI Desktop App](/en/projects/winui)** | Windows 10+ | ⭐⭐⭐ | Windows desktop UI | 2️⃣ |
| **[API Service](/en/projects/api)** | Windows/Linux/macOS | ⭐⭐⭐⭐ | Raspberry Pi robots, IoT integration | 3️⃣ |
| **[MAUI Cross-platform](/en/projects/maui)** | Android/iOS/Windows/macOS | ⭐⭐⭐⭐⭐ | Mobile app development | 4️⃣ |
...
**[Start learning Console project →](/en/projects/console)**
...
**[Start learning WinUI project →](/en/projects/winui)**
...
**[Start learning API project →](/en/projects/api)**
...
**[Start learning MAUI project →](/en/projects/maui)**
...
- **Desktop app developers** → [WinUI Project](/en/projects/winui)
- **Backend/API developers** → [API Project](/en/projects/api)
- **Mobile app developers** → [MAUI Project](/en/projects/maui)
- **System administrators** → [Console Project](/en/projects/console)
...
- **[Getting Started](/en/guide/getting-started)** - 5-minute quick guide
- **[Environment Setup](/en/guide/environment-setup)** - Development environment configuration
- **[Tech Stack Introduction](/en/guide/tech-stack)** - Learn about technologies used
- **[Project Architecture](/en/guide/architecture)** - Understand system design
