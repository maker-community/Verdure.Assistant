...
namespace Verdure.Assistant.Core.Services.MCP.Tests
{
    /// <summary>
    /// Test class to verify MCP protocol response handling after fixes
    /// </summary>
    public class McpResponseHandlingTest
    {
        public static async Task TestMcpResponseHandling()
        {
